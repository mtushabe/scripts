...
DSD.lookup<- read.csv("sc_lookup.csv",header=TRUE,sep=",",check.names = FALSE,stringsAsFactors=FALSE)

shaping("SC_ARVDISP.csv",2,"SC_ARVDISP-Final")
shaping("SC_CURR.csv",2,"SC_CURR-Final")

datafile<-"SC_ARVDISP-Final.csv"
...
Violations_SC_ARVDISP <-validateData(data = d, datasets = c("jKdHXpBfWop","em1U5x9hhXh","qzVASYuaIey","mbdbMiLZ4AA","BPEyzcDb8fT"),return_violations_only = TRUE)
datafile<-"SC_CURR-Final.csv"
d<-d2Parser(filename = datafile ,type = "csv")
checkDataElementOrgunitValidity(data = d,datasets = c("jKdHXpBfWop","em1U5x9hhXh","qzVASYuaIey","BPEyzcDb8fT","mbdbMiLZ4AA","zL8TlPVzEBZ","TBcmmtoaCBC","mbdbMiLZ4AA","qHyrHc4zwx4"))
checkDataElementDisaggValidity(data=d,datasets = c("jKdHXpBfWop","em1U5x9hhXh","qzVASYuaIey","BPEyzcDb8fT","mbdbMiLZ4AA","zL8TlPVzEBZ","TBcmmtoaCBC","mbdbMiLZ4AA","qHyrHc4zwx4"))
checkValueTypeCompliance(d)
checkNegativeValues(d)
Violations_SC_CURR <-validateData(data = d, datasets = c("jKdHXpBfWop","em1U5x9hhXh","qzVASYuaIey","mbdbMiLZ4AA","BPEyzcDb8fT"),return_violations_only = TRUE)
DSD.lookup<- read.csv("dsd_lookup.csv",header=TRUE,sep=",",check.names = FALSE,stringsAsFactors=FALSE)
shaping("KP_PREV.csv",2,"KP_PREV-Final")
datafile<-"KP_PREV-Final.csv"
d<-d2Parser(filename = datafile ,type = "csv")
checkDataElementOrgunitValidity(data = d,datasets = c("jKdHXpBfWop","em1U5x9hhXh","qzVASYuaIey","BPEyzcDb8fT","mbdbMiLZ4AA","zL8TlPVzEBZ","TBcmmtoaCBC","mbdbMiLZ4AA","qHyrHc4zwx4"))
checkDataElementDisaggValidity(data=d,datasets = c("jKdHXpBfWop","em1U5x9hhXh","qzVASYuaIey","BPEyzcDb8fT","mbdbMiLZ4AA","zL8TlPVzEBZ","TBcmmtoaCBC","mbdbMiLZ4AA","qHyrHc4zwx4"))
checkValueTypeCompliance(d)
checkNegativeValues(d)
Violations_KP_PREV <-validateData(data = d, datasets = c("jKdHXpBfWop","em1U5x9hhXh","qzVASYuaIey","mbdbMiLZ4AA","BPEyzcDb8fT"),return_violations_only = TRUE)
